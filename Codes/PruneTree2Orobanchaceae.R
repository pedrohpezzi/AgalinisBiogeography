...
# Script used to prune the Lamiales tree from Fonseca (2021) down to only Orobanchaceae species.  
...
tree <- read.tree("Fonseca2021_SuppMaterial/1-s2.0-S1055790321002207-mmc1/Lamiales_dated.nwk.tre") #this can be download from the supplemental material of Fonseca (2021)
ggtree(tree)
